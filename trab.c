...
int main() 
 { 
     ...
     printf("Olá, meu nome é Nícolas Serrano e este programa pode ser visto no seguinte endereço do github: https://github.com/nicktoadd/prog1trabalhoav2/blob/master/trab.c\n"); 
